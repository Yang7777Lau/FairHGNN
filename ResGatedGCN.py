...
from torch_geometric.nn import HANConv,GCNConv,to_hetero,SAGEConv ,GraphConv ,GCNConv ,ResGatedGraphConv
import argparse
...
print('ResGatedGCN F1-sorce:', "%0.2f%%" % (final_F1 * 100))
print('ResGatedGCN F1-mean:', "%0.2f%%" % (final_F1_mean * 100))
print('ResGatedGCN F1-bias:', "%0.2f%%" % (final_F1_bias * 100))